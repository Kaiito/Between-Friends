...
#import "BFEventViewController.h"

@interface BFEventViewController ()

@end

@implementation BFEventViewController
...
- (void)checkCoreDataContent
{
  ...
  NSLog(@"Nombre de Contacts dans CD : %d", [fetchedObjects count]);
