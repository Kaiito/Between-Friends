...
@interface BFEventViewController : UIViewController <UITextFieldDelegate, ABPeoplePickerNavigationControllerDelegate ,UIScrollViewDelegate, AVAudioPlayerDelegate>
{
...
@property (strong, nonatomic) UITableViewController *syntheseTableView;
